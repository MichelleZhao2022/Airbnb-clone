...
ActiveRecord::Schema[7.0].define(version: 20_221_202_033_157) do
  ...
  create_table 'favorites', force: :cascade do |t|
    ...
    t.index %w[property_id user_id], name: 'index_favorites_on_property_id_and_user_id', unique: true
  ...
  create_table 'reservations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[property_id user_id reservation_date],
            name: 'idx_reserv_on_property_id_and_user_id_and_reserv_date', unique: true
